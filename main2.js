...
class Game{
    ...
    init() {
        ...
        loader.load( 'Soldier000.fbx', function ( object ) {
			...
			tloader.load("Soldier_image1.jpg", function(texture){
                object.traverse( function ( child ) {
                    if ( child.isMesh ) {
						child.material = new THREE.MeshStandardMaterial( { color: 0xCBB44D, skinning: true } );
...
function handleMouseMove(event) {
	...
	var targetY = normalize(mousePos.y, -1, 1, -100, 100);
